...
const routes: Routes = [
  ...
  { path: '', canActivate: [checkLoggedInGuard], component: PublicComponent,  loadChildren: () => import('./layout/public/public.module').then(m => m.PublicModule) },
  { path: '', canActivate:[AuthGuard], component: SecureComponent, loadChildren: () => import('./layout/secure/secure.module').then(m => m.SecureModule) },
