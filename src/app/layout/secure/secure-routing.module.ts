...
const routes: Routes = [
  ...
  { path: 'event-registration', loadChildren: () => import('../../modules/settings/event-registration/event-registration.module').then(m => m.EventRegistrationModule) },
  { path: 'assessment-configuration', loadChildren: () => import('../../modules/settings/assessment-crateria/assessment-crateria.module').then(m => m.AssessmentCrateriaModule) },
  ...
  { path: 'standard-subject', loadChildren: () => import('../../modules/settings/add-standard-subject/add-standard-subject.module').then(m => m.AddStandardSubjectModule) },
