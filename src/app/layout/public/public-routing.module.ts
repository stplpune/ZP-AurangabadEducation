...
const routes: Routes = [
  ...
  { path: 'forgot-password', loadChildren: () => import('../../before-login/forget-password/forget-password.module').then(m => m.ForgetPasswordModule), data: { breadcrumb: [{ title: 'Login', active: true }] } },
